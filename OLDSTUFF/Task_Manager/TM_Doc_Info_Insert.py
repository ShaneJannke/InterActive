...
def TM_Doc_Info_Insert(Sub_Request_V, Report_Text, root):
    ...
    #open popup with entry boxes 
        ...
        try:
            ...
            name = Label(top,text = "Work Order # " + WO + " ECN/DOC Req Info ")
            name.pack()
            ...
            def sub_submit(e1,WO):
                ...
                try:
                    EXE_STRING = "EXEC Testdatabase.dbo.TM_Doc_Info_Insert @WONO=?, @ECN=?"
