...
def Main_Tree_8(Tree):
    
    #Define Our Columns
    Tree['columns'] = ("Request_ID","Status","PCBA","PCBA_REV","Bare_PCB","PCB_REV","Stencil_Need_Order","Start_Date",
                        "Feedback","PCBA_Doc","PCBA_Doc_REV")
    
    # Format Our Columns
    Tree.column("#0", width=20, stretch = False)
    Tree.column("Request_ID", anchor= W, width = 90, stretch = False)
    Tree.column("Status", anchor= W, width = 110, stretch = False)
    Tree.column("PCBA", anchor= W, width = 70, stretch = False)
    Tree.column("PCBA_REV", anchor= W, width = 75, stretch = False)
    Tree.column("Bare_PCB", anchor= W, width = 76, stretch = False)
    Tree.column("PCB_REV", anchor= W, width= 90, stretch = False)
    ...
    Tree.column("PCBA_Doc", anchor= W, width = 110, stretch = False)
    Tree.column("PCBA_Doc_REV", anchor= W, width = 110, stretch = False)

    #Create Headings
    Tree.heading("#0", text = "", anchor = W)
    Tree.heading("Request_ID", text = "Request_ID", anchor = W)
